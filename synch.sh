# Actualizar el script principal con la estructura correcta
cat > /home/gacel/zienshield/scripts/sync-companies-to-wazuh.js << 'EOF'
#!/usr/bin/env node
...
chmod +x /home/gacel/zienshield/scripts/sync-companies-to-wazuh.js
